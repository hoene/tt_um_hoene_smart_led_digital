...
async def test_protocol_select_bin(dut):
    ...
    dut.protocol_select_parity_error.value = 0
...
@cocotb.test()
async def test_protocol_select_parity_error(dut):
    dut._log.info("protocol select parity error start")
    ...
    dut.protocol_select_in0selected.value = 1
    dut.protocol_select_bits.value = 0
    dut.protocol_select_parity_error.value = 1
...
@cocotb.test()
async def test_protocol_select_protocol_error(dut):
    dut._log.info("protocol select protocol start")
    ...
    assert dut.protocol_select_pwm_set.value == 0
    assert dut.protocol_select_swap_forward_bit.value == 0
    assert dut.protocol_select_error.value == 1
    assert dut.protocol_select_state.value == 3
